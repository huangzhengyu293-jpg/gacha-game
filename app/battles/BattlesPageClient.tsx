...
export default function BattlesPageClient({
  ...
  return (
    <div
      className="w-full px-4 sm:px-6 md:px-8 pb-12 overflow-x-hidden"
      style={{ paddingLeft: 'max(env(safe-area-inset-left, 0px), 16px)', paddingRight: 'max(env(safe-area-inset-right, 0px), 16px)' }}
    >
      <div className="flex gap-8 max-w-[1248px] mx-auto">
        <div className="flex-1 xl:max-w-[992px] min-w-0">
          ...
          <div className="mt-6">
            <BattleModes sortValue={sortValue} initialFightList={initialFightList} />
          </div>
        </div>
        <BestLiveSidebar
