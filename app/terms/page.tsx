    ...
    <div className={CONTAINER_CLASS}>
      <section className={SECTION_CLASS}>
        <article>
          ...
          <p>
            KawaguchiDraw.com is operated by PD Operations B.V. (hereinafter
            “KawaguchiDraw”, “Company”, “We” or “Us”), a company duly incorporated
          ...
          <p>
            By registering an account at <span className="underline">www.KawaguchiDraw.com</span> (the “Website”), you enter into
            an agreement with KawaguchiDraw, and agree to be bound by these Terms of
          ...
          <ul className={LIST_CLASS}>
            <li>
              ...
              to your user account created on KawaguchiDraw.com.
            </li>
            <li>
          ...
          <p>
            ...
            offensive or targeted toward specific groups, KawaguchiDraw, or its
            staff. KawaguchiDraw reserves the right to reject registrations or
          ...
          <ul className={LIST_CLASS}>
            <li>
              Your KawaguchiDraw account is not a bank account or investment product.
            </li>
            <li>
          ...
          <ul className={LIST_CLASS}>
            <li>
              You will comply with court orders and will not link to KawaguchiDraw in
          ...
          <p>
            ...
            <Link
              href="mailto:Support@KawaguchiDraw.com"
              className="text-blue-400 underline"
            >
          ...
          <p>
            To purchase packs or use KawaguchiDraw products, add balance through
          ...
          <p>
            You do not own the software; it remains the property of KawaguchiDraw or
          ...
          <p>
            ...
            If your activity causes KawaguchiDraw to incur legal expenses to comply
          ...
          <p>
            You agree to defend, indemnify, and hold KawaguchiDraw, its affiliates,
          ...
          <p>
            ...
            to identification from provided content. You release KawaguchiDraw and
            its affiliates from all claims arising from your use of KawaguchiDraw.
          </p>
          ...
          <p>
            KawaguchiDraw and related marks are proprietary trademarks. Product and
            ...
            KawaguchiDraw are our proprietary information protected by copyright law.
          </p>
          ...
          <p>
            ...
            Website, constitute the entire agreement between you and KawaguchiDraw.
          </p>
          ...
          <p>
            KawaguchiDraw is not liable for failure to fulfill obligations due to
