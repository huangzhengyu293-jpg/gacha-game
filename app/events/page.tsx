        ...
        <div className="rounded-lg p-4 md:p-8" style={{ backgroundColor: '#22272B' }}>
          <div className="relative rounded-lg" style={{ backgroundColor: '#1d2125' }}>
            <div className="absolute -top-6 left-0 w-full overflow-hidden rounded-lg" style={{ height: 'calc(100% + 1.5rem)' }}>
              <div className="absolute top-0 bg-contain bg-no-repeat bg-top w-[260px] h-[195px] xxs:w-[300px] xxs:h-[240px] sm:w-[426px] sm:h-[340px] -left-[110px] xxs:-left-[95px] xl:-left-[50px]" style={{ backgroundImage: 'url(https://packdraw.com/_next/static/media/flag.a3897cd0.png)' }}></div>
              <div className="absolute top-0 bg-contain bg-no-repeat bg-top w-[260px] h-[195px] xxs:w-[300px] xxs:h-[240px] sm:w-[426px] sm:h-[340px] -right-[110px] xxs:-right-[95px] xl:-right-[50px]" style={{ backgroundImage: 'url(https://packdraw.com/_next/static/media/flag.a3897cd0.png)', transform: 'scaleX(-1)' }}></div>
            </div>
              ...
              >
                <div className="rounded-lg p-4 md:p-8" style={{ backgroundColor: '#22272B' }}>
                  <div className="relative mb-4 px-8">
                    <div className="absolute top-0 left-2 sm:left-1 bg-contain bg-no-repeat bg-center h-full aspect-[32/170]" style={{ backgroundImage: 'url(https://packdraw.com/_next/static/media/raffle-ticket.49e185ba.svg)' }}></div>
                    ...
                    <div className="absolute top-0 right-2 sm:right-1 bg-contain bg-no-repeat bg-center h-full aspect-[32/170]" style={{ backgroundImage: 'url(https://packdraw.com/_next/static/media/raffle-ticket.49e185ba.svg)', transform: 'scaleX(-1)' }}></div>
                  </div>
                </div>
                ...
                <div className="flex flex-col rounded-lg p-4 pt-6 md:p-8 my-6" style={{ backgroundColor: '#22272B' }}>
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1 rounded-lg relative flex justify-end overflow-hidden items-center min-h-[90px] xl:min-h-[115px] py-4 xl:py-7 px-3" style={{ backgroundColor: '#1d2125' }}>
                      <div className="absolute h-full w-full top-0 bg-left -left-[50px]" style={{ backgroundImage: 'url(https://packdraw.com/_next/static/media/about-raffle-1.fa7b7732.svg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}></div>
                    ...
                    <div className="flex-1 rounded-lg relative flex justify-end overflow-hidden pl-2 items-center min-h-[90px] xl:min-h-[115px]" style={{ backgroundColor: '#1d2125' }}>
                      <div className="absolute bg-contain bg-no-repeat bg-left h-full w-2/3 lg:w-2/5 -left-[20px] xs:left-[20px] md:-left-[35px] lg:left-0" style={{ backgroundImage: 'url(https://packdraw.com/_next/static/media/about-raffle-2.0aef317d.svg)' }}></div>
